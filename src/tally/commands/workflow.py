...
def cmd_workflow(args):
    ...
    print(f"    {C.CYAN}{{fee}}{C.RESET}         {C.DIM}Fee column added to amount{C.RESET}")
    print(f"    {C.CYAN}{{-fee}}{C.RESET}        {C.DIM}Negate fee before adding{C.RESET}")
    print(f"    {C.CYAN}{{+fee}}{C.RESET}        {C.DIM}Absolute fee before adding{C.RESET}")
    print()
